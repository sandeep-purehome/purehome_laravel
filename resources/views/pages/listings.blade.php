			...
			@foreach ($listings as $listing)
				...
				<div class=" listings col-md-4">
					...
					<div class=" card-property">
						...
						<h2 class="price">AED {{ $listing->price }}</h2>
						<div class="row">
							<div class="col-md-4 col-xs-4">
								<h3 class="specs">{{ $listing->unit_builtup_area }}</h3>
							</div>
							<div class="col-md-4 col-xs-4">
								<h3 class="specs">{{ $listing->bedrooms }}</h3>
							</div>
							<div class="col-md-4 col-xs-4">
								<h3 class="specs">{{ $listing->no_of_bathroom }}</h3>
							</div>
						</div>
						<p class="description">
